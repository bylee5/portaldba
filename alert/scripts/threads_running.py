...
sql = '''
	...
	AND a.monitoring_code_seqno in (2)
        ...
        for row in res:
            ...
            if thread_count < threshold_num:
                ...
                if errored_at != None:
                    ...
                    username = "Moni"
                    channel = "monitor"
                    text = "[OK] {0} threads_running=*{1}*".format(dbname, str(thread_count))
            ...
            # 모니터링 조건에 맞는 결과가 있는 경우
                ...
                if errored_at == None or (how_long_error >= alert_term and monitoring_now == 1):
                    ...
                    if check_count_current >= check_count_threshold:
                        ...
                        username = "Moni"
                        channel = "monitor"
                        text = "[PROBLEM] {0} threads_running=*{1}*".format(dbname, str(thread_count))
