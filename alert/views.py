...
def threads_running(request):
    ...
    return render(request, 'alert/threads_running.html', context)

@login_required
def threads_running_select(request):
    if request.method == 'POST':
        alert_yn = request.POST.get('s_alert_yn')
        alert_title = request.POST.get('s_alert_title')
        alert_dbsvr = request.POST.get('s_alert_dbsvr')
        ...
        s_query = '''
                ...
                FROM db_monitoring a
                    ...
                    join db_monitoring_code c on (a.monitoring_code_seqno = c.monitoring_code_seqno)
                WHERE 1=1
                AND a.monitoring_code_seqno in (select monitoring_code_seqno from db_monitoring_code where monitoring_code_title like '%running%')
                '''
        s_query += alert_yn
        s_query += alert_title
        s_query += alert_dbsvr
        ...
        return render(request, 'alert/threads_running_select.html', context)
    else:
        return render(request, 'alert/threads_running.html', context)
...
def slave_delay(request):
    ...
    return render(request, 'alert/slave_delay.html', context)

@login_required
def slave_delay_select(request):
    if request.method == 'POST':
        alert_yn = request.POST.get('s_alert_yn')
        alert_title = request.POST.get('s_alert_title')
        alert_dbsvr = request.POST.get('s_alert_dbsvr')
        ...
        return render(request, 'alert/slave_delay_select.html', context)
    else:
        return render(request, 'alert/slave_delay.html', context)
...
def innodb_lock(request):
    ...
    return render(request, 'alert/innodb_lock.html', context)

@login_required
def innodb_lock_select(request):
    if request.method == 'POST':
        alert_yn = request.POST.get('s_alert_yn')
        alert_title = request.POST.get('s_alert_title')
        alert_dbsvr = request.POST.get('s_alert_dbsvr')
        ...
        return render(request, 'alert/innodb_lock_select.html', context)
    else:
        return render(request, 'alert/innodb_lock.html', context)
...
def slow_query(request):
    ...
    return render(request, 'alert/slow_query.html', context)

@login_required
def slow_query_select(request):
    if request.method == 'POST':
        alert_yn = request.POST.get('s_alert_yn')
        alert_title = request.POST.get('s_alert_title')
        alert_dbsvr = request.POST.get('s_alert_dbsvr')
        ...
        return render(request, 'alert/slow_query_select.html', context)
    else:
        return render(request, 'alert/slow_query.html', context)
...
def undo_size(request):
    ...
    return render(request, 'alert/undo_size.html', context)

@login_required
def undo_size_select(request):
    if request.method == 'POST':
        alert_yn = request.POST.get('s_alert_yn')
        alert_title = request.POST.get('s_alert_title')
        alert_dbsvr = request.POST.get('s_alert_dbsvr')
        ...
        s_query = '''
                ...
                FROM db_monitoring a
                    ...
                    join db_monitoring_code c on (a.monitoring_code_seqno = c.monitoring_code_seqno)
                WHERE 1=1
                AND a.monitoring_code_seqno in (select monitoring_code_seqno from db_monitoring_code where monitoring_code_title like '%undo%')
                '''
        s_query += alert_yn
        s_query += alert_title
        s_query += alert_dbsvr
        ...
        return render(request, 'alert/undo_size_select.html', context)
    else:
        return render(request, 'alert/undo_size.html', context)
...
def connection_check(request):
    ...
    return render(request, 'alert/connection_check.html', context)

@login_required
def connection_check_select(request):
    if request.method == 'POST':
        alert_yn = request.POST.get('s_alert_yn')
        alert_title = request.POST.get('s_alert_title')
        alert_dbsvr = request.POST.get('s_alert_dbsvr')
        ...
        s_query = '''
                ...
                FROM db_monitoring a
                    ...
                    join db_monitoring_code c on (a.monitoring_code_seqno = c.monitoring_code_seqno)
                WHERE 1=1
                AND a.monitoring_code_seqno in (select monitoring_code_seqno from db_monitoring_code where monitoring_code_title like '%connection%')
                '''
        s_query += alert_yn
        s_query += alert_title
        s_query += alert_dbsvr
        ...
        return render(request, 'alert/connection_check_select.html', context)
    else:
        return render(request, 'alert/connection_check.html', context)