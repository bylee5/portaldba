"""
Django settings for portaldba project.
...
SECRET_KEY = 'django-insecure-&jmuvaw+lbe*!25$cf***zbul_preo8e8rg4mw3-0jp+uv%_c*'
ENC_KEY = 'kvxdba'
...
WSGI_APPLICATION = 'portaldba.wsgi.application'
